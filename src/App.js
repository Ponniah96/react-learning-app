...
import RouterChild1 from "./3.ReactComponent/2-FunctionalComponent/13.RouterChild1.js";
import RouterChild2 from "./3.ReactComponent/2-FunctionalComponent/13.RouterChild2.js";
      ...
      <BrowserRouter>
        <div className="header-navbar">
          <nav className="top-nav-bar">
            <ul style={{ padding: "0px", margin: "0px" }}>
              <li>
                <Link className="top-nav-bar-links" to="/react-learning-app">
                  Home
                </Link>
              </li>
              <li>
                ...
                <div className="top-nav-dropdown" style={{ display: "none" }}>
                  <Link className="top-nav-dropdown-links" to="/class-intro">
                    Introduction
                  </Link>
                  <Link className="top-nav-dropdown-links" to="/class-jsx">
                    JSX
                  </Link>
                  <Link className="top-nav-dropdown-links" to="/class-props">
                    Props
                  </Link>
                  <Link className="top-nav-dropdown-links" to="/class-state">
                    States
                  </Link>
                  ...
                  <Link className="top-nav-dropdown-links" to="/class-events">
                    Events
                  </Link>
                  <Link className="top-nav-dropdown-links" to="/class-forms">
                    Forms
                  </Link>
                  <Link className="top-nav-dropdown-links" to="/class-arrays">
                    Arrays
                  </Link>
                </div>
              </li>
              <li>
                ...
                <div className="top-nav-dropdown" style={{ display: "none" }}>
                  ...
                  <Link className="top-nav-dropdown-links" to="/functional-jsx">
                    JSX
                  </Link>
                  <Link
                    className="top-nav-dropdown-links"
                  ...
                  <Link
                    className="top-nav-dropdown-links"
                    to="/functional-callback"
                  >
                    useCallback
                  </Link>
                  <Link
                    className="top-nav-dropdown-links"
                    to="/functional-reducer"
                  >
                    useReducer
                  </Link>
                </div>
              ...
              <li>
                ...
                <div className="top-nav-dropdown" style={{ display: "none" }}>
                  <a
                    className="top-nav-dropdown-links"
                    href="https://ponniah96.github.io/reactCartApplication/"
                    target="_blank"
                  >
                    Cart Application
                  </a>
                  <a
                    className="top-nav-dropdown-links"
                    href="https://ponniah96.github.io/crud-operation"
                    target="_blank"
                  >
                    CRUD Application
                  </a>
                  ...
                  <a
                    className="top-nav-dropdown-links"
                    href="https://ponniah96.github.io/react-custom-table-app/"
                    target="_blank"
                  >
                    Custom Table Using Material UI
                  </a>
                </div>
              </li>
              <li>
                ...
                <div className="top-nav-dropdown" style={{ display: "none" }}>
                  ...
                  <Link className="top-nav-dropdown-links" to="/npm-commands">
                    NPM Commands
                  </Link>
                </div>
              </li>
        ...
        <div className="body">
          <Routes>
            ...
            <Route
              path="/class-props"
              element={<ClassComponentProps name="Ponniah" age="26" />}
            ></Route>
            <Route
              path="/class-state"
              element={<ClassComponentStates />}
            ></Route>
            ...
            <Route
              path="/functional-intro"
              element={<FunctionalIntro />}
            ></Route>
            <Route
              path="/functional-jsx"
            ...
            ></Route>
            <Route
              path="/functional-props"
              element={<FunctionalComponentProps name="Ponniah" age="26" />}
            ></Route>
            <Route
              path="/functional-state"
              element={<FunctionalComponentStates />}
            ></Route>
            ...
            <Route
              path="/functional-effect"
              element={<FunctionalEffects />}
            ></Route>
            <Route
              path="/functional-context"
              element={<FunctionalUseContext />}
            ></Route>
            <Route path="/functional-memo" element={<FunctionalMemo />}></Route>
            <Route
              path="/functional-callback"
              element={<FunctionalCallback />}
            ></Route>
            <Route
              path="/functional-reducer"
              element={<FunctionalReducer />}
            ></Route>
            <Route
              path="/functional-custom-hooks"
              element={<CustomHooks />}
            ></Route>
            <Route
              path="/functional-promise"
              element={<PromiseFunction />}
            ></Route>
            <Route path="/functional-router" element={<FunctionalRouter />}>
              <Route path="" element={<RouterChild1 />}></Route>
              <Route path="2" element={<RouterChild2 />}></Route>
            </Route>
            <Route
              path="/functional-forms"
              element={<FunctionalForms />}
            ></Route>
